...
#
# a = [{'total': '58', 'of_user': '卓云龙', 'rank': 1}, {'total': '54', 'of_user': '卓云龙', 'rank': 2},
#       {'total': '52', 'of_user': '钟友明','rank': 3}, {'total': '51', 'of_user': '毛毛',  'rank': 4},
#       {'total': '50', 'of_user': '毛毛',  'rank': 5},{'total': '49', 'of_user': '毛毛',  'rank': 6}]
# count_times= {}
# bb = []
# for i in a:
#     count = count_times.get(i.get('of_user'),0) + 1
#     print(count)
#     count_times[i.get('of_user')] = count
#     print(count_times)
#     if count <= 1 :
#         bb.append(i)
# # print(count_times)
